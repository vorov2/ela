...
namespace Ela.CodeModel
{
    public struct ElaLiteralValue : IEquatable<ElaLiteralValue>
    {
        ...
        public ElaLiteralValue(string value, char postfix)
        {
            data = new Conv();
            objval = value;
            Postfix = postfix;
            LiteralType = ElaTypeCode.__Reserved;
        }
        ...
        public override string ToString()
        {
            switch (LiteralType)
            {
                ...
                case ElaTypeCode.__Reserved: return AsString() + Postfix;
        ...
        public bool Equals(ElaLiteralValue value)
        {
            ...
            switch (LiteralType)
            {
                ...
                case ElaTypeCode.__Reserved: return AsString() == value.AsString()
